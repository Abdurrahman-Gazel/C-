...
namespace MernisServiceReference1
{
    ...
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<MernisServiceReference1.KPSPublicSoap>, MernisServiceReference1.KPSPublicSoap
    {
        ...
        internal void TCKimlikNoDogrula(string nationalityId, string v1, string v2, int year)
        {
            throw new NotImplementedException();
        }

        internal void TCKimlikNoDogrula(long nationalityId, string v1, string v2, int year)
        {
            throw new NotImplementedException();
        }

        internal void TCKimlikNoDogrula(ulong v1, string v2, string v3, int year)
        {
            throw new NotImplementedException();
        }
